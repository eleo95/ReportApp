...
public class ReportsFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ImageView camButton = view.findViewById(R.id.camImgBtn);
        FrameLayout locationBtn = view.findViewById(R.id.post_location);
        ...
        switch (v.getId()) {
            ...
            case R.id.submit_button:
                if (!postTitle.getText().toString().equals("") && !postDescription.getText().toString().equals("") && postLocation != null && mImageUri != null) {
                    ...
                    Toast.makeText(getContext(), getString(R.string.report_field_check), Toast.LENGTH_SHORT).show();
                }
                break;
    ...
    private File createImageFile() {
        ...
        if (!mediaStorageDir.exists()) {
            if (!mediaStorageDir.mkdirs()) {
                Log.d(IMAGE_DIRECTORY_NAME, "Error create "
